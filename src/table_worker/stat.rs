...
pub mod helpers {
    ...
    pub async fn process_query_table<T: TableWorkerStatic>(
        pool: &PgPool,
        query: &str,
    ) -> Result<(), AppError> {
    ...
    pub async fn process_table_to_string<T: TableWorkerStatic>(
        pool: &PgPool,
        query: &str,
    ...
    pub async fn process_table_to_json<T: TableWorkerStatic>(
        pool: &PgPool,
        query: &str,
    ...
    pub async fn process_table_to_df<T: TableWorkerStatic>(
        pool: &PgPool,
        query: &str,
        ctx: &SessionContext,
    ) -> Result<DataFrame, AppError> {
